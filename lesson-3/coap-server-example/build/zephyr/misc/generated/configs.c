...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_CSL_MIN_RECEIVE_ON, 350);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_COAPS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_COMMISSIONER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_CSL_RECEIVER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_DHCP6_CLIENT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_DHCP6_SERVER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_DIAG, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_ENABLE_SERVICE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_EXTERNAL_HEAP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_IP6_FRAGM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_JAM_DETECTION, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_UDP_FORWARD, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENTHREAD_NORDIC_LIBRARY_MASTER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_CDC_ACM_RINGBUF_SIZE, 2048);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OT_COMMAND_LINE_INTERFACE_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OT_COMMAND_LINE_INTERFACE_LOG_LEVEL, 3);
